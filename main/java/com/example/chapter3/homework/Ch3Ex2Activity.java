...
public class Ch3Ex2Activity extends AppCompatActivity {
    ...
    private void resetTargetAnimation() {
        ...
        ObjectAnimator transparencyAnimatorX=ObjectAnimator.ofFloat(target,
                "translationX",1.0f,0.5f);
        transparencyAnimatorX.setRepeatCount(ValueAnimator.INFINITE);
        transparencyAnimatorX.setInterpolator(new LinearInterpolator());
        transparencyAnimatorX.setDuration(1000);
        transparencyAnimatorX.setRepeatMode(ValueAnimator.REVERSE);
        ObjectAnimator transparencyAnimatorY=ObjectAnimator.ofFloat(target,
                "translationY",1.0f,0.5f);
        transparencyAnimatorY.setRepeatCount(ValueAnimator.INFINITE);
        transparencyAnimatorY.setInterpolator(new LinearInterpolator());
        transparencyAnimatorY.setDuration(1000);
        transparencyAnimatorY.setRepeatMode(ValueAnimator.REVERSE);
        // TODO ex2-3: 将上面创建的其他 ObjectAnimator 都添加到 AnimatorSet 中
        animatorSet = new AnimatorSet();
        animatorSet.playTogether(animator1,scaleXAnimator,scaleYAnimator,transparencyAnimatorX,transparencyAnimatorY);
        animatorSet.start();
    }
}
