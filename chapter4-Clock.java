...
public class Clock extends View {
    ...
    private void drawDegrees(Canvas canvas) {
        ...
        for (int i = 0; i < FULL_ANGLE; i += 6 /* Step */) {
            ...
            /*if(i % 30 == 0){
                drawHoursValues(canvas,startX,startY,i/30,paint);
            }*/
        }
    }
     ...
     * @param canvas
     */
    private void drawHoursValues(Canvas canvas,int X,int Y,int hour,Paint paint) {
        // Default Color:
        // - hoursValuesColor
        /*
    ...
    private void drawNeedles(final Canvas canvas) {
        ...
        //Log.d("yzm",nowHours+"点"+nowMinutes+"分"+nowSeconds+"秒"+'\n');
        // 画秒针
